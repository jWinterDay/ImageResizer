...
class LoadResult {
  ...
  factory LoadResult.init() => LoadResult(
        error: null,
        isLoading: false,
        image: null,
  ...
  factory LoadResult.loading() => LoadResult(
        error: null,
        isLoading: true,
        image: null,
        imageFormat: null,
  ...
  factory LoadResult.completed(Image image,
          {int imageFormat = CustomImageFormat.IF_16_TO_9}) =>
      LoadResult(
        error: null,
        isLoading: false,
        image: image,
  ...
  factory LoadResult.fromRawJson(String str) =>
      LoadResult.fromJson(json.decode(str));
  ...
  @override
  String toString() =>
      'isLoading: $isLoading, error: $error, image: $image, imageFormat: $imageFormat';
}
